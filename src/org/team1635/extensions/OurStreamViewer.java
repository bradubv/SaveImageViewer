 ...
 * @author Greg Granito
 * 
 * Thanks a bunch Greg.  Because imageToDraw is private and not protected
 * we cannot extend this class to expose it so it can be saved to file
 * so we have to cut and paste.
 */
public abstract class OurStreamViewer extends StaticWidget {
